...
from .views import ProductList, ProductDetail, ProductCreate, ProductUpdate, ProductDelete, GetAllUserProducts, \
    temp, CategoryList
...
urlpatterns = [
    ...
    path('category_items/<int:pk>', CategoryList.as_view(), name='all_category_products'),
]
